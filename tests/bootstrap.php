 ...
 */
function _lookit_seo_autofill_load_plugin() {
	require dirname( __DIR__ ) . '/lookit-seo-autofill.php';
}
tests_add_filter( 'muplugins_loaded', '_lookit_seo_autofill_load_plugin' );
